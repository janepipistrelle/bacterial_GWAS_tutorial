...
It should unpack into ```~/data``` (this step take a while, so we're going to get it running and go through the background).
...
* List of paths to software dependencies.
