...
```
#Bash Shell
Rscript bacterialGWAS/kmerGWAS/kmerAnalysis.R -dataFile ~/data/fus300.kmerfiles.txt -prefix fus -removeKmerTxt FALSE -minCov 5 -externalSoftware dependencies.txt
```
